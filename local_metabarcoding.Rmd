...
Finally we will conduct an automated search against the Australian Faunal Directory and the Atlast of Living Australia to see if these species have been recorded in Australia before
...
ala_quality_filter <- select_filters(
      basisOfRecord = c("HumanObservation", "PreservedSpecimen", "LivingSpecimen",
                      "MaterialSample", "NomenclaturalChecklist", "FossilSpecimen"))
